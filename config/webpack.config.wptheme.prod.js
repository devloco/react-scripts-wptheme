...
if (wpThemeUserConfig && typeof wpThemeUserConfig.homepage === "string") {
    if (wpThemeUserConfig.ensureTrailingSlash) {
        userHomepageSetting = wpThemeUserConfig.homepage + (wpThemeUserConfig.homepage.endsWith("/") ? "" : "/");
    } else {
        userHomepageSetting = wpThemeUserConfig.homepage;
    }
}

// Webpack uses `publicPath` to determine where the app is being served from.
// It requires a trailing slash, or the file assets will get an incorrect path.
const publicPath = userHomepageSetting || paths.servedPath;
